...
export const Cpu = props => (
  <svg viewBox="0 0 20 20" width="16px" height="16px" {...props} className={`sketchybar-app-font ${props.className ? props.className : ''}`}><path d="M16.8 7.2H7.2v9.6h9.6V7.2z" fillRule="evenodd" />,
